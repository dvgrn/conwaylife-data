# get-all-patterns.py
# Scrapes conwaylife.com forums to find all posted patterns
# Can be adapted to retrieve patterns only from new posts numbered greater than 86262
#   (the highest post number at the time this script was run in mid-December 2019)
# TODO: This will mean discarding any patterns found with a lastpost value less than 86263.
